...
class TestPortFunctions:
    ...
    def test_is_port_in_use_with_available_port(self, mocker):
    ...
    def test_is_port_in_use_with_unavailable_port(self, mocker):
    ...
    def test_get_available_port_with_default(self, mocker):
    ...
    def test_get_available_port_with_specified_port(self, mocker):
    ...
    def test_get_available_port_with_first_port_unavailable(self, mocker):
        ...
        # Verify functions were called correctly
        assert mock_in_use.call_args_list == [mocker.call(8080), mocker.call(8081)]
        assert port == 8081

    def test_get_available_port_with_invalid_port(self, mocker):
    ...
    def test_get_available_port_no_ports_available(self, mocker):
...
class TestLocalHostFunction:
    ...
    def test_get_local_host_ipv4(self, mocker):
        ...
        mocker.patch("ipaddress.ip_address", return_value=mock_ip)
    ...
    def test_get_local_host_ipv6(self, mocker):
        ...
        mock_ip = mocker.MagicMock(spec=ipaddress.IPv6Address)
        mock_ip.is_multicast = False
        mock_ip.is_reserved = False
        mock_ip.is_link_local = False
        mock_ip.is_loopback = False
    ...
    def test_get_local_host_no_valid_address(self, mocker):
    ...
    def test_get_local_host_with_invalid_address(self, mocker):
